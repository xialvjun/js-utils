...
var get_path_1 = require("./get_path");
/**
...
function set_path(obj, path, value) {
    ...
    if (paths.length === 1) {
        ...
        if (typeof paths_0 === "number") {
            var clone = Object(obj || []).slice();
            clone[paths_0] = value;
            return clone;
        }
        return Object.assign({}, obj, (_a = {}, _a[paths_0] = value, _a));
    }
    var tail = set_path(get_path_1.get_path(obj, paths.slice(0, -1)), paths.slice(-1), value);
